...
class ProcessInstancesApi extends base_api_1.BaseApi {
    ...
    filterProcessInstances(filterRequest) {
        assert_1.throwIfNotDefined(filterRequest, 'filterRequest');
    ...
    getHistoricProcessInstances(queryRequest) {
        assert_1.throwIfNotDefined(queryRequest, 'queryRequest');
    ...
    getProcessInstances(processInstancesQuery) {
        assert_1.throwIfNotDefined(processInstancesQuery, 'processInstancesQuery');
    ...
    startNewProcessInstance(startRequest) {
        assert_1.throwIfNotDefined(startRequest, 'startRequest');
