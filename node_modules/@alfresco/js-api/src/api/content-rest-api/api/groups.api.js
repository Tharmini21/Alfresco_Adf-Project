...
class GroupsApi extends base_api_1.BaseApi {
    createGroup(groupBodyCreate, opts) {
        assert_1.throwIfNotDefined(groupBodyCreate, 'groupBodyCreate');
        opts = opts || {};
    ...
    createGroupMembership(groupId, groupMembershipBodyCreate, opts) {
        ...
        assert_1.throwIfNotDefined(groupMembershipBodyCreate, 'groupMembershipBodyCreate');
        opts = opts || {};
    ...
    deleteGroupMembership(groupId, groupMemberId) {
        assert_1.throwIfNotDefined(groupId, 'groupId');
        assert_1.throwIfNotDefined(groupMemberId, 'groupMemberId');
        const postBody = null;
        const pathParams = {
    ...
    updateGroup(groupId, groupBodyUpdate, opts) {
        assert_1.throwIfNotDefined(groupId, 'groupId');
        assert_1.throwIfNotDefined(groupBodyUpdate, 'groupBodyUpdate');
        opts = opts || {};
