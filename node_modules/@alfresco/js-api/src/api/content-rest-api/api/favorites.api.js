...
class FavoritesApi extends base_api_1.BaseApi {
    createFavorite(personId, favoriteBodyCreate, opts) {
        ...
        assert_1.throwIfNotDefined(favoriteBodyCreate, 'favoriteBodyCreate');
        opts = opts || {};
    ...
    createSiteFavorite(personId, favoriteSiteBodyCreate, opts) {
        assert_1.throwIfNotDefined(personId, 'personId');
        assert_1.throwIfNotDefined(favoriteSiteBodyCreate, 'favoriteSiteBodyCreate');
        opts = opts || {};
    ...
    deleteFavorite(personId, favoriteId) {
        assert_1.throwIfNotDefined(personId, 'personId');
        assert_1.throwIfNotDefined(favoriteId, 'favoriteId');
        const postBody = null;
        const pathParams = {
