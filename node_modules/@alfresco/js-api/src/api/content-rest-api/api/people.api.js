...
class PeopleApi extends base_api_1.BaseApi {
    createPerson(personBodyCreate, opts) {
        assert_1.throwIfNotDefined(personBodyCreate, 'personBodyCreate');
        opts = opts || {};
    ...
    requestPasswordReset(personId, clientBody) {
        assert_1.throwIfNotDefined(personId, 'personId');
        assert_1.throwIfNotDefined(clientBody, 'clientBody');
    ...
    resetPassword(personId, passwordResetBody) {
        assert_1.throwIfNotDefined(personId, 'personId');
        assert_1.throwIfNotDefined(passwordResetBody, 'passwordResetBody');
    ...
    updatePerson(personId, personBodyUpdate, opts) {
        assert_1.throwIfNotDefined(personId, 'personId');
        assert_1.throwIfNotDefined(personBodyUpdate, 'personBodyUpdate');
        opts = opts || {};
