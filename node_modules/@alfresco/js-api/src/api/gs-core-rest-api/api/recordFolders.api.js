...
class RecordFoldersApi extends base_api_1.BaseApi {
    createRecordFolderChild(recordFolderId, recordBodyCreate, opts) {
        assert_1.throwIfNotDefined(recordFolderId, 'recordFolderId');
        assert_1.throwIfNotDefined(recordBodyCreate, 'recordBodyCreate');
        opts = opts || {};
    ...
    updateRecordFolder(recordFolderId, recordFolderBodyUpdate, opts) {
        assert_1.throwIfNotDefined(recordFolderId, 'recordFolderId');
        assert_1.throwIfNotDefined(recordFolderBodyUpdate, 'recordFolderBodyUpdate');
        opts = opts || {};
