...
var NodesApi = (function (_super) {
    ...
    NodesApi.prototype.requestContentUrl = function (nodeId, opts) {
        throwIfNotDefined(nodeId, 'nodeId');
        opts = opts || {};
        var postBody = opts['requestContentUrlBodyCreate'];
        var pathParams = {
            'nodeId': nodeId
        };
        var queryParams = {};
        ...
        var contentTypes = ['application/json'];
        var accepts = ['application/json'];
        return this.apiClient.callApi('/nodes/{nodeId}/request-content-url', 'POST', pathParams, queryParams, headerParams, formParams, postBody, contentTypes, accepts, DirectAccessUrlEntry);
    };
    NodesApi.prototype.requestContentUrl_1 = function (nodeId, renditionId, opts) {
        throwIfNotDefined(nodeId, 'nodeId');
        ...
        var contentTypes = ['application/json'];
        var accepts = ['application/json'];
        return this.apiClient.callApi('/nodes/{nodeId}/renditions/{renditionId}/request-content-url', 'POST', pathParams, queryParams, headerParams, formParams, postBody, contentTypes, accepts, DirectAccessUrlEntry);
    };
    NodesApi.prototype.requestContentUrl_2 = function (nodeId, versionId, opts) {
        throwIfNotDefined(nodeId, 'nodeId');
        ...
        var contentTypes = ['application/json'];
        var accepts = ['application/json'];
        return this.apiClient.callApi('/nodes/{nodeId}/versions/{versionId}/request-content-url', 'POST', pathParams, queryParams, headerParams, formParams, postBody, contentTypes, accepts, DirectAccessUrlEntry);
    };
    NodesApi.prototype.requestContentUrl_3 = function (nodeId, versionId, renditionId, opts) {
        throwIfNotDefined(nodeId, 'nodeId');
        throwIfNotDefined(versionId, 'versionId');
        throwIfNotDefined(renditionId, 'renditionId');
        opts = opts || {};
        ...
        var contentTypes = ['application/json'];
        var accepts = ['application/json'];
        return this.apiClient.callApi('/nodes/{nodeId}/versions/{versionId}/renditions/{renditionId}/request-content-url', 'POST', pathParams, queryParams, headerParams, formParams, postBody, contentTypes, accepts, DirectAccessUrlEntry);
    };
