(function (global, factory) {
    ...
    ***************************************************************************** */
    ...
    var CustomResourcesService = /** @class */ (function () {
        ...
        Object.defineProperty(CustomResourcesService.prototype, "api", {
            get: function () {
        ...
        Object.defineProperty(CustomResourcesService.prototype, "peopleApi", {
            get: function () {
                return this._peopleApi || (this._peopleApi = new jsApi.PeopleApi(this.api));
            },
            enumerable: false,
            configurable: true
        });
        Object.defineProperty(CustomResourcesService.prototype, "sitesApi", {
            get: function () {
                return this._sitesApi || (this._sitesApi = new jsApi.SitesApi(this.api));
            },
            enumerable: false,
            configurable: true
        });
        Object.defineProperty(CustomResourcesService.prototype, "searchApi", {
            get: function () {
                return this._searchApi || (this._searchApi = new jsApi.SearchApi(this.api));
            },
            enumerable: false,
            configurable: true
        });
        Object.defineProperty(CustomResourcesService.prototype, "favoritesApi", {
            get: function () {
                return this._favoritesApi || (this._favoritesApi = new jsApi.FavoritesApi(this.api));
            },
            enumerable: false,
            configurable: true
        });
        Object.defineProperty(CustomResourcesService.prototype, "sharedLinksApi", {
            get: function () {
                return this._sharedLinksApi || (this._sharedLinksApi = new jsApi.SharedlinksApi(this.api));
            },
            enumerable: false,
            configurable: true
        });
        Object.defineProperty(CustomResourcesService.prototype, "trashcanApi", {
            get: function () {
                return this._trashcanApi || (this._trashcanApi = new jsApi.TrashcanApi(this.api));
            },
            enumerable: false,
            configurable: true
        });
        Object.defineProperty(CustomResourcesService.prototype, "nodesApi", {
            get: function () {
                return this._nodesApi || (this._nodesApi = new jsApi.NodesApi(this.api));
            },
            enumerable: false,
            configurable: true
        });
    ...
    var BaseQueryBuilderService = /** @class */ (function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            ...
                            return [4 /*yield*/, this.alfrescoApiService.getInstance().search.searchApi.search(query)];
                        case 1:
        ...
        BaseQueryBuilderService.prototype.search = function (queryBody) {
            var _this = this;
            var promise = this.alfrescoApiService.searchApi.search(queryBody);
        ...
        VersionListComponent.prototype.restore = function (versionId) {
            ...
            if (this.canUpdate()) {
                this.versionsApi
                    ...
                    .then(function () { return _this.alfrescoApi.nodesApi.getNodeInfo(_this.node.id, { include: ['permissions', 'path', 'isFavorite', 'allowableOperations'] }); })
    ...
    var ContentTypeService = /** @class */ (function () {
        ...
        ContentTypeService.prototype.getContentTypeByPrefix = function (prefixedType) {
            return rxjs.from(this.alfrescoApiService.typesApi.getType(prefixedType));
        };
        ContentTypeService.prototype.getContentTypeChildren = function (nodeType) {
            ...
            return rxjs.from(this.alfrescoApiService.typesApi.listTypes(opts)).pipe(operators.map(function (result) { return result.list.entries; }));
        };
    ...
    var ContentMetadataService = /** @class */ (function () {
        ...
        ContentMetadataService.prototype.getGroupedProperties = function (node, presetName) {
            ...
            if (node.aspectNames) {
                var contentMetadataConfig_1 = this.contentMetadataConfigFactory.get(presetName), groupNames = node.aspectNames
    ...
    var AspectListService = /** @class */ (function () {
        ...
        AspectListService.prototype.getStandardAspects = function (whiteList) {
            ...
            return rxjs.from(this.alfrescoApiService.aspectsApi.listAspects(opts))
    ...
    var NodePermissionService = /** @class */ (function () {
        ...
        NodePermissionService.prototype.getGroupMemberByGroupName = function (groupName, opts) {
            return rxjs.from(this.apiService.groupsApi.listGroupMemberships(groupName, opts));
        };
    ...
    var NodeSharedDirective = /** @class */ (function () {
        ...
        NodeSharedDirective.prototype.shareNode = function (nodeEntry) {
            ...
            if (nodeEntry && nodeEntry.entry && nodeEntry.entry.isFile) {
                ...
                if (nodeId) {
                    this.getNodeInfo(nodeId).subscribe(function (entry) {
    ...
    var GroupService = /** @class */ (function () {
        ...
        GroupService.prototype.listAllGroupMembershipsForPerson = function (personId, opts, accumulator) {
            ...
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, this.alfrescoApiService.groupsApi.listGroupMembershipsForPerson(personId, opts)];
                        case 1:
                            groupsPaginated = _a.sent();
