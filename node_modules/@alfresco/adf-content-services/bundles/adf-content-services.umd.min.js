...
/*!
     ...
     * limitations under the License.
     */
var re=function(){};re.decorators=[{type:n.NgModule,args:[{imports:[t.CommonModule,j,A.TranslateModule],declarations:[ne,ie,oe],exports:[ne,ie]}]}];
/*!
     * @license
     * Copyright 2019 Alfresco Software, Ltd.
     *
...
/*!
     ...
     * limitations under the License.
     */
var ae=function(){function e(e,t){this.apiService=e,this.logService=t}return e.prototype.getRating=function(e,t){return T.from(this.apiService.getInstance().core.ratingsApi.getRating(e,t)).pipe(O.catchError(this.handleError))},e.prototype.postRating=function(e,t,n){var i=new D.RatingBody({id:t,myRating:n});return T.from(this.apiService.getInstance().core.ratingsApi.rate(e,i)).pipe(O.catchError(this.handleError))},e.prototype.deleteRating=function(e,t){return T.from(this.apiService.getInstance().core.ratingsApi.removeRating(e,t)).pipe(O.catchError(this.handleError))},e.prototype.handleError=function(e){return this.logService.error(e),T.throwError(e||"Server error")},e}();ae.ɵprov=n.ɵɵdefineInjectable({factory:function(){return new ae(n.ɵɵinject(C.AlfrescoApiService),n.ɵɵinject(C.LogService))},token:ae,providedIn:"root"}),ae.decorators=[{type:n.Injectable,args:[{providedIn:"root"}]}],ae.ctorParameters=function(){return[{type:C.AlfrescoApiService},{type:C.LogService}]};
/*!
     * @license
     * Copyright 2019 Alfresco Software, Ltd.
     *
...
/*!
     ...
     * limitations under the License.
     */
var de=function(){function e(e,t){this.apiService=e,this.logService=t,this.refresh=new n.EventEmitter}return e.prototype.getTagsByNodeId=function(e){var t=this;return T.from(this.apiService.getInstance().core.tagsApi.getNodeTags(e)).pipe(O.catchError((function(e){return t.handleError(e)})))},e.prototype.getAllTheTags=function(e){var t=this;return T.from(this.apiService.getInstance().core.tagsApi.getTags(e)).pipe(O.catchError((function(e){return t.handleError(e)})))},e.prototype.addTag=function(e,t){var n=this,i=new D.TagBody;i.tag=t;var o=T.from(this.apiService.getInstance().core.tagsApi.addTag(e,[i]));return o.subscribe((function(e){n.refresh.emit(e)}),(function(e){n.handleError(e)})),o},e.prototype.removeTag=function(e,t){var n=this,i=T.from(this.apiService.getInstance().core.tagsApi.removeTag(e,t));return i.subscribe((function(e){n.refresh.emit(e)}),(function(e){n.handleError(e)})),i},e.prototype.handleError=function(e){return this.logService.error(e),T.throwError(e||"Server error")},e}();de.ɵprov=n.ɵɵdefineInjectable({factory:function(){return new de(n.ɵɵinject(C.AlfrescoApiService),n.ɵɵinject(C.LogService))},token:de,providedIn:"root"}),de.decorators=[{type:n.Injectable,args:[{providedIn:"root"}]}],de.ctorParameters=function(){return[{type:C.AlfrescoApiService},{type:C.LogService}]},de.propDecorators={refresh:[{type:n.Output}]};
/*!
     * @license
     * Copyright 2019 Alfresco Software, Ltd.
     *
...
/*!
     ...
     * limitations under the License.
     */
var fe=function(){};fe.decorators=[{type:n.NgModule,args:[{imports:[t.CommonModule,j,N.FormsModule,N.ReactiveFormsModule,C.CoreModule],exports:[pe,ue,he],declarations:[pe,ue,he]}]}];
/*!
     * @license
     * Copyright 2019 Alfresco Software, Ltd.
     *
...
/*!
     ...
     * limitations under the License.
     */
var De=function(e){e&&(this.type=e.type||null,this.action=e.action||null,this.permission=e.permission||null)},we=function(){function t(e,t,i,o,r,a,s){this.contentDialogService=e,this.dialogRef=t,this.content=i,this.documentListService=o,this.apiService=r,this.dialog=a,this.downloadService=s,this.error=new n.EventEmitter}return t.prototype.downloadNode=function(e){new C.NodeDownloadDirective(this.apiService,this.downloadService,this.dialog).downloadNode(e)},t.prototype.copyContent=function(t,n){return this.doFileOperation(e.NodeAction.COPY,"content",t,n)},t.prototype.copyFolder=function(t,n){return this.doFileOperation(e.NodeAction.COPY,"folder",t,n)},t.prototype.moveContent=function(t,n){return this.doFileOperation(e.NodeAction.MOVE,"content",t,n)},t.prototype.moveFolder=function(t,n){return this.doFileOperation(e.NodeAction.MOVE,"folder",t,n)},t.prototype.doFileOperation=function(e,t,n,i){var o=this,r=new T.Subject;return this.contentDialogService.openCopyMoveDialog(e,n,i).subscribe((function(i){var a=i[0];o.documentListService[e.toLowerCase()+"Node"].call(o.documentListService,n.id,a.id).subscribe(r.next.bind(r,"OPERATION.SUCCESS."+t.toUpperCase()+"."+e),r.error.bind(r))}),(function(e){return r.error(e),r})),r},t}();we.ɵprov=n.ɵɵdefineInjectable({factory:function(){return new we(n.ɵɵinject(te),n.ɵɵinject(c.MatDialog),n.ɵɵinject(C.ContentService),n.ɵɵinject(Z),n.ɵɵinject(C.AlfrescoApiService),n.ɵɵinject(c.MatDialog),n.ɵɵinject(C.DownloadService))},token:we,providedIn:"root"}),we.decorators=[{type:n.Injectable,args:[{providedIn:"root"}]}],we.ctorParameters=function(){return[{type:te},{type:c.MatDialog},{type:C.ContentService},{type:Z},{type:C.AlfrescoApiService},{type:c.MatDialog},{type:C.DownloadService}]},we.propDecorators={error:[{type:n.Output}]};var Ne=function(){function e(e,t,n,i,o){this.nodeActionsService=e,this.contentNodeDialogService=t,this.translation=n,this.documentListService=i,this.contentService=o,this.permissionEvent=new T.Subject,this.error=new T.Subject,this.success=new T.Subject,this.handlers={},this.setupActionHandlers()}return e.prototype.getHandler=function(e){if(e){var t=e.toLowerCase();return this.handlers[t]||null}return null},e.prototype.setHandler=function(e,t){if(e){var n=e.toLowerCase();return this.handlers[n]=t,!0}return!1},e.prototype.canExecuteAction=function(e){return this.documentListService&&e&&!0===e.entry.isFile},e.prototype.setupActionHandlers=function(){this.handlers.copy=this.copyNode.bind(this),this.handlers.move=this.moveNode.bind(this),this.handlers.delete=this.deleteNode.bind(this),this.handlers.download=this.downloadNode.bind(this),this.handlers.lock=this.lockNode.bind(this)},e.prototype.lockNode=function(e){return this.contentNodeDialogService.openLockNodeDialog(e.entry)},e.prototype.downloadNode=function(e){this.nodeActionsService.downloadNode(e)},e.prototype.copyNode=function(e,t,n){var i=this.nodeActionsService.copyContent(e.entry,n);return this.prepareHandlers(i),i},e.prototype.moveNode=function(e,t,n){var i=this.nodeActionsService.moveContent(e.entry,n);return this.prepareHandlers(i),i},e.prototype.prepareHandlers=function(e){var t=this;e.subscribe((function(e){t.success.next(e)}),this.error.next.bind(this.error))},e.prototype.deleteNode=function(e,t,n){var i=this;if(this.canExecuteAction(e)){if(this.contentService.hasAllowableOperations(e.entry,n)){var o=this.documentListService.deleteNode(e.entry.id);return o.subscribe((function(){var t=i.translation.instant("CORE.DELETE_NODE.SINGULAR",{name:e.entry.name});i.success.next(t)}),(function(){var t=i.translation.instant("CORE.DELETE_NODE.ERROR_SINGULAR",{name:e.entry.name});i.error.next(t)})),o}return this.permissionEvent.next(new De({type:"content",action:"delete",permission:n})),T.throwError(new Error("No permission to delete"))}return T.of()},e}();Ne.ɵprov=n.ɵɵdefineInjectable({factory:function(){return new Ne(n.ɵɵinject(we),n.ɵɵinject(te),n.ɵɵinject(C.TranslationService),n.ɵɵinject(Z),n.ɵɵinject(C.ContentService))},token:Ne,providedIn:"root"}),Ne.decorators=[{type:n.Injectable,args:[{providedIn:"root"}]}],Ne.ctorParameters=function(){return[{type:we},{type:te},{type:C.TranslationService},{type:Z},{type:C.ContentService}]};var Le=function(){function e(e,t,n,i){this.nodeActionsService=e,this.documentListService=t,this.contentService=n,this.translation=i,this.permissionEvent=new T.Subject,this.error=new T.Subject,this.success=new T.Subject,this.handlers={},this.setupActionHandlers()}return e.prototype.getHandler=function(e){if(e){var t=e.toLowerCase();return this.handlers[t]||null}return null},e.prototype.setHandler=function(e,t){if(e){var n=e.toLowerCase();return this.handlers[n]=t,!0}return!1},e.prototype.canExecuteAction=function(e){return this.documentListService&&e&&!0===e.entry.isFolder},e.prototype.setupActionHandlers=function(){this.handlers.copy=this.copyNode.bind(this),this.handlers.move=this.moveNode.bind(this),this.handlers.delete=this.deleteNode.bind(this),this.handlers.download=this.downloadNode.bind(this)},e.prototype.downloadNode=function(e){this.nodeActionsService.downloadNode(e)},e.prototype.copyNode=function(e,t,n){var i=this.nodeActionsService.copyFolder(e.entry,n);return this.prepareHandlers(i,t),i},e.prototype.moveNode=function(e,t,n){var i=this.nodeActionsService.moveFolder(e.entry,n);return this.prepareHandlers(i,t),i},e.prototype.prepareHandlers=function(e,t){var n=this;e.subscribe((function(e){t&&"function"==typeof t.reload&&t.reload(),n.success.next(e)}),this.error.next.bind(this.error))},e.prototype.deleteNode=function(e,t,n){var i=this;if(this.canExecuteAction(e)){if(this.contentService.hasAllowableOperations(e.entry,n)){var o=this.documentListService.deleteNode(e.entry.id);return o.subscribe((function(){t&&"function"==typeof t.reload&&t.reload();var n=i.translation.instant("CORE.DELETE_NODE.SINGULAR",{name:e.entry.name});i.success.next(n)}),(function(){var t=i.translation.instant("CORE.DELETE_NODE.ERROR_SINGULAR",{name:e.entry.name});i.error.next(t)})),o}return this.permissionEvent.next(new De({type:"folder",action:"delete",permission:n})),T.throwError(new Error("No permission to delete"))}return T.of()},e}();Le.ɵprov=n.ɵɵdefineInjectable({factory:function(){return new Le(n.ɵɵinject(we),n.ɵɵinject(Z),n.ɵɵinject(C.ContentService),n.ɵɵinject(C.TranslationService))},token:Le,providedIn:"root"}),Le.decorators=[{type:n.Injectable,args:[{providedIn:"root"}]}],Le.ctorParameters=function(){return[{type:we},{type:Z},{type:C.ContentService},{type:C.TranslationService}]};
/*!
     * @license
     * Copyright 2019 Alfresco Software, Ltd.
     *
     ...
     * limitations under the License.
     */
var Re=function(){function e(e){this.documentList=e}return e.prototype.registerAction=function(e){return!(!this.documentList||!e)&&(this.documentList.actions.push(e),!0)},e.prototype.unregisterAction=function(e){if(this.documentList&&e){var t=this.documentList.actions.indexOf(e);if(t>=0)return this.documentList.actions.splice(t,1),!0}return!1},e}();Re.decorators=[{type:n.Component,args:[{selector:"content-actions",template:""}]}],Re.ctorParameters=function(){return[{type:Oe}]};
/*!
     * @license
     * Copyright 2019 Alfresco Software, Ltd.
     *
...
/*!
     ...
     * limitations under the License.
     */
var Me=function(){function e(e){this.api=e,this.displayText$=new T.BehaviorSubject(""),this.onDestroy$=new T.Subject}return e.prototype.ngOnInit=function(){var e=this;this.updateValue(),this.api.nodeUpdated.pipe(O.takeUntil(this.onDestroy$)).subscribe((function(t){var n=e.context.row;if(n){var i=n.node.entry;i===t&&(n.node={entry:i},e.updateValue())}}))},e.prototype.updateValue=function(){var e=this.context.row.node;if(e&&e.entry)switch(e.entry.role){case D.Site.RoleEnum.SiteManager:this.displayText$.next("LIBRARY.ROLE.MANAGER");break;case D.Site.RoleEnum.SiteCollaborator:this.displayText$.next("LIBRARY.ROLE.COLLABORATOR");break;case D.Site.RoleEnum.SiteContributor:this.displayText$.next("LIBRARY.ROLE.CONTRIBUTOR");break;case D.Site.RoleEnum.SiteConsumer:this.displayText$.next("LIBRARY.ROLE.CONSUMER");break;default:this.displayText$.next("LIBRARY.ROLE.NONE")}},e.prototype.ngOnDestroy=function(){this.onDestroy$.next(!0),this.onDestroy$.complete()},e}();Me.decorators=[{type:n.Component,args:[{selector:"adf-library-role-column",template:'\n        <span class="adf-datatable-cell-value" title="{{ (displayText$ | async) | translate }}">\n            {{ (displayText$ | async) | translate }}\n        </span>\n    ',changeDetection:n.ChangeDetectionStrategy.OnPush,encapsulation:n.ViewEncapsulation.None,host:{class:"adf-library-role-column adf-datatable-content-cell"}}]}],Me.ctorParameters=function(){return[{type:C.AlfrescoApiService}]},Me.propDecorators={context:[{type:n.Input}]};
/*!
     * @license
     * Copyright 2019 Alfresco Software, Ltd.
     *
     ...
     * limitations under the License.
     */
var ke=function(){function e(e){this.api=e,this.displayText$=new T.BehaviorSubject(""),this.onDestroy$=new T.Subject}return e.prototype.ngOnInit=function(){var e=this;this.updateValue(),this.api.nodeUpdated.pipe(O.takeUntil(this.onDestroy$)).subscribe((function(t){var n=e.context.row;if(n){var i=n.node.entry;i===t&&(n.node={entry:i},e.updateValue())}}))},e.prototype.updateValue=function(){var e=this.context.row.node;if(e&&e.entry)switch(e.entry.visibility){case D.Site.VisibilityEnum.PUBLIC:this.displayText$.next("LIBRARY.VISIBILITY.PUBLIC");break;case D.Site.VisibilityEnum.PRIVATE:this.displayText$.next("LIBRARY.VISIBILITY.PRIVATE");break;case D.Site.VisibilityEnum.MODERATED:this.displayText$.next("LIBRARY.VISIBILITY.MODERATED");break;default:this.displayText$.next("UNKNOWN")}},e.prototype.ngOnDestroy=function(){this.onDestroy$.next(!0),this.onDestroy$.complete()},e}();ke.decorators=[{type:n.Component,args:[{selector:"adf-library-status-column",template:'\n        <span class="adf-datatable-cell-value" title="{{ (displayText$ | async) | translate }}">\n            {{ (displayText$ | async) | translate }}\n        </span>\n    ',host:{class:"adf-library-status-column adf-datatable-content-cell"}}]}],ke.ctorParameters=function(){return[{type:C.AlfrescoApiService}]},ke.propDecorators={context:[{type:n.Input}]};
/*!
     * @license
     * Copyright 2019 Alfresco Software, Ltd.
     *
     ...
     * limitations under the License.
     */
var xe=function(){function e(e,t){this.element=e,this.alfrescoApiService=t,this.key="name",this.displayText$=new T.BehaviorSubject(""),this.onDestroy$=new T.Subject}return e.prototype.ngOnInit=function(){var e=this;this.updateValue(),this.alfrescoApiService.nodeUpdated.pipe(O.takeUntil(this.onDestroy$)).subscribe((function(t){var n=e.context.row;if(n){var i=n.node.entry;i===t&&(n.node={entry:i},e.updateValue())}}))},e.prototype.updateValue=function(){if(this.node=this.context.row.node,this.node&&this.node.entry){var e=this.context.row.getValue(this.key);this.displayText$.next(e||this.node.entry.id)}},e.prototype.onClick=function(){this.element.nativeElement.dispatchEvent(new CustomEvent("name-click",{bubbles:!0,detail:{node:this.node}}))},e.prototype.ngOnDestroy=function(){this.onDestroy$.next(!0),this.onDestroy$.complete()},e}();xe.decorators=[{type:n.Component,args:[{selector:"adf-name-column",template:'\n        <span\n            role="link"\n            [attr.aria-label]="\'NAME_COLUMN_LINK.ACCESSIBILITY.ARIA_LABEL\' | translate:{\n                name:  displayText$ | async\n            }"\n            class="adf-datatable-cell-value"\n            title="{{ node | adfNodeNameTooltip }}"\n            (click)="onClick()">\n\n            {{ displayText$ | async }}\n        </span>\n    ',changeDetection:n.ChangeDetectionStrategy.OnPush,encapsulation:n.ViewEncapsulation.None,host:{class:"adf-datatable-content-cell adf-datatable-link adf-name-column"}}]}],xe.ctorParameters=function(){return[{type:n.ElementRef},{type:C.AlfrescoApiService}]},xe.propDecorators={context:[{type:n.Input}],key:[{type:n.Input}]};
/*!
     * @license
     * Copyright 2019 Alfresco Software, Ltd.
     *
...
/*!
     ...
     * limitations under the License.
     */
var ct=function(){};ct.decorators=[{type:n.NgModule,args:[{imports:[C.CoreModule,t.CommonModule,j,R.A11yModule],declarations:[st,rt,it,ot,Ze,et,Je,at,lt],exports:[st,rt,it,ot,Ze,et,Je,at,lt]}]}];
/*!
     * @license
     * Copyright 2019 Alfresco Software, Ltd.
     *
...
/*!
     ...
     * limitations under the License.
     */
var wt=function(){function e(e,t){this.queryBuilder=e,this.facetFiltersService=t,this.showContextFacets=!0,this.facetQueriesLabel="Facet Queries",this.facetExpanded={default:!1},e.config&&e.config.facetQueries&&(this.facetQueriesLabel=e.config.facetQueries.label||"Facet Queries",this.facetExpanded.query=e.config.facetQueries.expanded),e.config&&e.config.facetFields&&(this.facetExpanded.field=e.config.facetFields.expanded),e.config&&e.config.facetIntervals&&(this.facetExpanded.interval=e.config.facetIntervals.expanded),this.displayResetButton=this.queryBuilder.config&&!!this.queryBuilder.config.resetButton}return e.prototype.shouldExpand=function(e){return this.facetExpanded[e.type]||this.facetExpanded.default},e.prototype.getBucketCountDisplay=function(e){return null===e.count?"":"("+e.count+")"},e}();wt.decorators=[{type:n.Component,args:[{selector:"adf-search-filter",template:'<mat-accordion multi="true" displayMode="flat">\n\n    <button *ngIf="displayResetButton && facetFiltersService.responseFacets"\n            mat-button\n            color="primary"\n            matTooltip="{{ \'SEARCH.FILTER.BUTTONS.RESET-ALL.TOOLTIP\' | translate }}"\n            matTooltipPosition="right"\n            adf-reset-search>\n        {{ \'SEARCH.FILTER.BUTTONS.RESET-ALL.LABEL\' | translate }}\n    </button>\n    <mat-expansion-panel\n        *ngFor="let category of queryBuilder.categories"\n        [attr.data-automation-id]="\'expansion-panel-\'+category.name"\n        [(expanded)]="category.expanded">\n        <mat-expansion-panel-header>\n            <mat-panel-title>\n                {{ category.name | translate }}\n            </mat-panel-title>\n        </mat-expansion-panel-header>\n        <adf-search-widget-container\n            [id]="category.id"\n            [selector]="category.component.selector"\n            [settings]="category.component.settings">\n        </adf-search-widget-container>\n    </mat-expansion-panel>\n\n    <ng-container *ngIf="facetFiltersService.responseFacets && showContextFacets">\n        <mat-expansion-panel [attr.data-automation-id]="\'expansion-panel-\'+field.label" *ngFor="let field of facetFiltersService.responseFacets"\n                             [expanded]="shouldExpand(field)">\n            <mat-expansion-panel-header>\n                <mat-panel-title>{{ field.label | translate }}</mat-panel-title>\n            </mat-expansion-panel-header>\n\n            <adf-search-facet-field [field]="field"></adf-search-facet-field>\n\n        </mat-expansion-panel>\n    </ng-container>\n</mat-accordion>\n',encapsulation:n.ViewEncapsulation.None,host:{class:"adf-search-filter"}}]}],wt.ctorParameters=function(){return[{type:Ot,decorators:[{type:n.Inject,args:[_e]}]},{type:Dt}]},wt.propDecorators={showContextFacets:[{type:n.Input}]};
/*!
     * @license
     * Copyright 2019 Alfresco Software, Ltd.
     *
     ...
     * limitations under the License.
     */
var Nt=function(e){this.facetFiltersService=e,this.clearAll=!1};Nt.decorators=[{type:n.Component,args:[{selector:"adf-search-chip-list",template:'<mat-chip-list>\n    <ng-container *ngIf="facetFiltersService.selectedBuckets.length">\n        <mat-chip *ngIf="clearAll && facetFiltersService.selectedBuckets.length > 1"\n            data-automation-id="reset-filter"\n            color="primary"\n            selected\n            matTooltip="{{ \'SEARCH.FILTER.BUTTONS.CLEAR-ALL.TOOLTIP\' | translate }}"\n            matTooltipPosition="right"\n            (click)="facetFiltersService.resetAllSelectedBuckets()">\n            {{ \'SEARCH.FILTER.BUTTONS.CLEAR-ALL.LABEL\' | translate }}\n        </mat-chip>\n\n        <mat-chip\n            data-automation-id="chip-list-entry"\n            *ngFor="let selection of facetFiltersService.selectedBuckets"\n            [removable]="true"\n            (removed)="facetFiltersService.unselectFacetBucket(selection.field, selection.bucket)">\n            {{ (selection.bucket.display || selection.bucket.label) | translate }}\n            <mat-icon matChipRemove>cancel</mat-icon>\n        </mat-chip>\n    </ng-container>\n</mat-chip-list>\n',encapsulation:n.ViewEncapsulation.None,host:{class:"adf-search-chip-list"}}]}],Nt.ctorParameters=function(){return[{type:Dt}]},Nt.propDecorators={searchFilter:[{type:n.Input}],clearAll:[{type:n.Input}]};var Lt=function(){function e(){this.propertyTypes=["d:text","d:date","d:datetime"],this.modelPropertyTypeToSearchFilterTypeMap=new Map,this.modelPropertyTypeToSearchFilterTypeMap.set(this.propertyTypes[0],"text"),this.modelPropertyTypeToSearchFilterTypeMap.set(this.propertyTypes[1],"date-range"),this.modelPropertyTypeToSearchFilterTypeMap.set(this.propertyTypes[2],"datetime-range")}return e.prototype.convertCustomModelPropertiesToSearchCategories=function(){var e,t=this,n=[];return null===(e=this.customModels)||void 0===e||e.forEach((function(e){n.push(t.convertModelPropertyIntoSearchFilter(e))})),n},e.prototype.convertModelPropertyIntoSearchFilter=function(e){var t;return this.isTypeSupported(e.dataType)&&(t={id:e.prefixedName,name:e.prefixedName,expanded:!1,enabled:!0,component:{selector:this.modelPropertyTypeToSearchFilterTypeMap.get(e.dataType),settings:{pattern:e.prefixedName+":'(.*?)'",field:""+e.prefixedName,placeholder:"Enter the "+e.name}}}),t},e.prototype.isTypeSupported=function(e){return this.propertyTypes.includes(e)},e}();Lt.ɵprov=n.ɵɵdefineInjectable({factory:function(){return new Lt},token:Lt,providedIn:"root"}),Lt.decorators=[{type:n.Injectable,args:[{providedIn:"root"}]}],Lt.ctorParameters=function(){return[]};
/*!
     * @license
     * Copyright 2019 Alfresco Software, Ltd.
     *
     ...
     * limitations under the License.
     */
var Rt=function(){function e(e,t){this.contentNodeSelectorPanelService=e,this.queryBuilderService=t}return e.prototype.ngOnInit=function(){this.queryBuilderService.categories=this.contentNodeSelectorPanelService.convertCustomModelPropertiesToSearchCategories()},e.prototype.hasCustomModels=function(){var e,t;return(null===(t=null===(e=this.contentNodeSelectorPanelService)||void 0===e?void 0:e.customModels)||void 0===t?void 0:t.length)>0},e}();Rt.decorators=[{type:n.Component,args:[{selector:"adf-search-panel",template:'<div class="adf-search-panel-scrollable" data-automation-id="adf-search-panel-container">\n    <adf-search-filter *ngIf="hasCustomModels()"\n                       class="app-search-settings"\n                       [showContextFacets]="false">\n    </adf-search-filter>\n</div>\n',encapsulation:n.ViewEncapsulation.None,host:{class:"adf-search-panel"},styles:[".adf-search-panel-scrollable{max-height:300px;overflow:scroll}"]}]}],Rt.ctorParameters=function(){return[{type:Lt},{type:Ot,decorators:[{type:n.Inject,args:[_e]}]}]};
/*!
     * @license
     * Copyright 2019 Alfresco Software, Ltd.
     *
...
/*!
     ...
     * limitations under the License.
     */
var Mt=function(){function e(e){this.queryBuilder=e,this.formChange=new n.EventEmitter}return e.prototype.onSelectionChange=function(e){this.queryBuilder.updateSelectedConfiguration(e.index),this.formChange.emit(e)},e.prototype.getSelected=function(e){var t;return null===(t=e.find((function(e){return e.selected})))||void 0===t?void 0:t.name},e}();Mt.decorators=[{type:n.Component,args:[{selector:"adf-search-form",template:'<ng-container *ngIf="queryBuilder.searchForms | async as forms">\n\n    <ng-container *ngIf="forms.length === 1">\n        <button class="adf-search-form" disableRipple mat-button [title]="getSelected(forms) | translate">\n            <span class="adf-search-form-title">\n                    {{ getSelected(forms) | translate }}\n            </span>\n        </button>\n    </ng-container>\n\n    <ng-container  *ngIf="forms.length > 1">\n        <button class="adf-search-form"\n                [matMenuTriggerFor]="menu"\n                #menuTrigger="matMenuTrigger"\n                disableRipple\n                mat-button\n                [title]="getSelected(forms) | translate"\n                [matMenuTriggerRestoreFocus]="true">\n\n            <span class="adf-search-form-title" >\n                    {{ getSelected(forms) | translate }}\n            </span>\n\n            <mat-icon [class.adf-search-form-icon-selected]="menuTrigger.menuOpen" class="adf-search-form-icon">expand_more</mat-icon>\n        </button>\n\n        <mat-menu #menu="matMenu" backdropClass="adf-search-form-menu">\n            <button mat-menu-item *ngFor="let form of forms" (click)="onSelectionChange(form)">\n                {{form.name | translate}}\n            </button>\n        </mat-menu>\n    </ng-container>\n</ng-container>\n',encapsulation:n.ViewEncapsulation.None,styles:[""]}]}],Mt.ctorParameters=function(){return[{type:Ot,decorators:[{type:n.Inject,args:[_e]}]}]},Mt.propDecorators={formChange:[{type:n.Output}]};
/*!
     * @license
     * Copyright 2019 Alfresco Software, Ltd.
     *
     ...
     * limitations under the License.
     */
var kt=function(e,t){this.queryBuilder=e,this.facetFiltersService=t,this.showContextFacets=!0};kt.decorators=[{type:n.Component,args:[{selector:"adf-search-filter-chips",template:'<mat-chip-list aria-orientation="horizontal">\n    <ng-container *ngFor="let category of queryBuilder.categories">\n        <adf-search-widget-chip [category]="category"></adf-search-widget-chip>\n    </ng-container>\n\n    <ng-container *ngIf="facetFiltersService.responseFacets && showContextFacets">\n        <ng-container *ngFor="let field of facetFiltersService.responseFacets">\n            <adf-search-facet-chip [field]="field" [attr.data-automation-id]="\'search-fact-chip-\' + field.field" ></adf-search-facet-chip>\n        </ng-container>\n    </ng-container>\n</mat-chip-list>\n',encapsulation:n.ViewEncapsulation.None}]}],kt.ctorParameters=function(){return[{type:Ot,decorators:[{type:n.Inject,args:[_e]}]},{type:Dt}]},kt.propDecorators={showContextFacets:[{type:n.Input}]};
/*!
     * @license
     * Copyright 2019 Alfresco Software, Ltd.
     *
...
/*!
     ...
     * limitations under the License.
     */
var Bt=function(){function e(e){this.filterService=e}return e.prototype.onClick=function(){this.filterService.reset()},e}();Bt.decorators=[{type:n.Directive,args:[{selector:"[adf-reset-search]"}]}],Bt.ctorParameters=function(){return[{type:Dt}]},Bt.propDecorators={onClick:[{type:n.HostListener,args:["click"]}]};
/*!
     * @license
     * Copyright 2019 Alfresco Software, Ltd.
     *
     ...
     * limitations under the License.
     */
var jt=function(){};jt.decorators=[{type:n.NgModule,args:[{imports:[t.CommonModule,N.FormsModule,N.ReactiveFormsModule,j,C.CoreModule],declarations:[ut,pt,dt,wt,Nt,Tt,ht,mt,gt,vt,Rt,bt,It,At,Ft,Pt,Mt,kt,xt,_t,Ut,Vt,Bt],exports:[ut,pt,dt,wt,Nt,Tt,ht,mt,gt,vt,Rt,bt,It,At,Ft,Pt,Mt,kt,xt,_t,Bt],providers:[{provide:_e,useExisting:Ot}]}]}];
/*!
     * @license
     * Copyright 2019 Alfresco Software, Ltd.
     *
     ...
     * limitations under the License.
     */
var $t,Gt=function(){};Gt.decorators=[{type:n.NgModule,args:[{imports:[C.CoreModule,t.CommonModule,L.FlexLayoutModule,j,ct,C.EditJsonDialogModule,jt],declarations:[Oe,je,ke,Me,Pe,xe,Fe,Re,Be],exports:[Oe,je,ke,Me,Pe,xe,Fe,Re,Be]}]}],(
/*!
     * @license
     * Copyright 2019 Alfresco Software, Ltd.
     *
...
/*!
     ...
     * limitations under the License.
     */
var qt=function(){};qt.decorators=[{type:n.NgModule,args:[{imports:[t.CommonModule,j,N.FormsModule,N.ReactiveFormsModule,C.CoreModule],exports:[Ht],declarations:[Ht]}]}];
/*!
     * @license
     * Copyright 2019 Alfresco Software, Ltd.
     *
...
/*!
     ...
     * limitations under the License.
     */
var zt=function(){};zt.decorators=[{type:n.NgModule,args:[{imports:[t.CommonModule,j,C.CoreModule],exports:[Yt,Qt],declarations:[Yt,Qt]}]}];
/*!
     * @license
     * Copyright 2019 Alfresco Software, Ltd.
     *
...
/*!
     ...
     * limitations under the License.
     */
var Xt=function(){function e(e,t,i){this.alfrescoApi=e,this.contentService=t,this.dialog=i,this.versions=[],this.isLoading=!0,this.showComments=!0,this.allowDownload=!0,this.allowViewVersions=!0,this.showActions=!0,this.restored=new n.EventEmitter,this.deleted=new n.EventEmitter,this.viewVersion=new n.EventEmitter,this.versionsApi=this.alfrescoApi.versionsApi}return e.prototype.ngOnChanges=function(){this.loadVersionHistory()},e.prototype.canUpdate=function(){return this.contentService.hasAllowableOperations(this.node,"update")&&this.versions.length>1},e.prototype.canDelete=function(){return this.contentService.hasAllowableOperations(this.node,"delete")&&this.versions.length>1},e.prototype.restore=function(e){var t=this;this.canUpdate()&&this.versionsApi.revertVersion(this.node.id,e,{majorVersion:!0,comment:""}).then((function(){return t.alfrescoApi.nodesApi.getNodeInfo(t.node.id,{include:["permissions","path","isFavorite","allowableOperations"]})})).then((function(e){return t.onVersionRestored(e)}))},e.prototype.onViewVersion=function(e){this.viewVersion.emit(e)},e.prototype.loadVersionHistory=function(){var e=this;this.isLoading=!0,this.versionsApi.listVersionHistory(this.node.id).then((function(t){e.versions=t.list.entries,e.isLoading=!1}))},e.prototype.downloadVersion=function(e){if(this.allowDownload){var t=this.getVersionContentUrl(this.node.id,e,!0);this.downloadContent(t)}},e.prototype.deleteVersion=function(e){var t=this;this.canUpdate()&&this.dialog.open(Wt,{data:{title:"ADF_VERSION_LIST.CONFIRM_DELETE.TITLE",message:"ADF_VERSION_LIST.CONFIRM_DELETE.MESSAGE",yesLabel:"ADF_VERSION_LIST.CONFIRM_DELETE.YES_LABEL",noLabel:"ADF_VERSION_LIST.CONFIRM_DELETE.NO_LABEL"},minWidth:"250px"}).afterClosed().subscribe((function(n){!0===n&&t.alfrescoApi.versionsApi.deleteVersion(t.node.id,e).then((function(){return t.onVersionDeleted(t.node)}))}))},e.prototype.onVersionDeleted=function(e){this.loadVersionHistory(),this.deleted.emit(e)},e.prototype.onVersionRestored=function(e){this.loadVersionHistory(),this.restored.emit(e)},e.prototype.getVersionContentUrl=function(e,t,n){return this.alfrescoApi.contentApi.getContentUrl(e,n).replace("/content","/versions/"+t+"/content")},e.prototype.downloadContent=function(e){if(e){var t=document.createElement("a");t.style.display="none",t.href=e,document.body.appendChild(t),t.click(),document.body.removeChild(t)}},e}();Xt.decorators=[{type:n.Component,args:[{selector:"adf-version-list",template:'<mat-list class="adf-version-list" *ngIf="!isLoading; else loading_template">\n    <mat-list-item *ngFor="let version of versions; let idx = index">\n        <mat-icon mat-list-icon>insert_drive_file</mat-icon>\n        <h4 mat-line class="adf-version-list-item-name" [id]="\'adf-version-list-item-name-\' + version.entry.id" >{{version.entry.name}}</h4>\n        <p mat-line>\n            <span class="adf-version-list-item-version"  [id]="\'adf-version-list-item-version-\' + version.entry.id" >{{version.entry.id}}</span> -\n            <span class="adf-version-list-item-date"     [id]="\'adf-version-list-item-date-\' + version.entry.id" >{{version.entry.modifiedAt | date}}</span>\n        </p>\n        <p mat-line [id]="\'adf-version-list-item-comment-\'+ version.entry.id" class="adf-version-list-item-comment"\n           *ngIf="showComments">{{version.entry.versionComment}}</p>\n\n        <div *ngIf="showActions">\n            <mat-menu [id]="\'adf-version-list-action-menu-\'+version.entry.id"\n                      #versionMenu="matMenu" yPosition="below" xPosition="before">\n                <ng-container *adf-acs-version="\'7\'">\n                    <button *ngIf="allowViewVersions"\n                            [id]="\'adf-version-list-action-view-\'+version.entry.id"\n                            mat-menu-item\n                            (click)="onViewVersion(version.entry.id)">\n                        {{ \'ADF_VERSION_LIST.ACTIONS.VIEW\' | translate }}\n                    </button>\n                </ng-container>\n                <button\n                    [id]="\'adf-version-list-action-restore-\'+version.entry.id"\n                    [disabled]="!canUpdate()"\n                    mat-menu-item\n                    (click)="restore(version.entry.id)">\n                    {{ \'ADF_VERSION_LIST.ACTIONS.RESTORE\' | translate }}\n                </button>\n                <button *ngIf="allowDownload"\n                        [id]="\'adf-version-list-action-download-\'+version.entry.id"\n                        mat-menu-item\n                        (click)="downloadVersion(version.entry.id)">\n                    {{ \'ADF_VERSION_LIST.ACTIONS.DOWNLOAD\' | translate }}\n                </button>\n                <button\n                    [disabled]="!canDelete()"\n                    [id]="\'adf-version-list-action-delete-\'+version.entry.id"\n                    (click)="deleteVersion(version.entry.id)"\n                    mat-menu-item>\n                    {{ \'ADF_VERSION_LIST.ACTIONS.DELETE\' | translate }}\n                </button>\n            </mat-menu>\n\n            <button mat-icon-button [matMenuTriggerFor]="versionMenu" [id]="\'adf-version-list-action-menu-button-\'+version.entry.id">\n                <mat-icon>more_vert</mat-icon>\n            </button>\n        </div>\n    </mat-list-item>\n</mat-list>\n\n<ng-template #loading_template>\n    <mat-progress-bar data-automation-id="version-history-loading-bar" mode="indeterminate"\n                      color="accent"></mat-progress-bar>\n</ng-template>\n',encapsulation:n.ViewEncapsulation.None,host:{class:"adf-version-list"},styles:[".adf-version-list .mat-list-item-content{border-bottom:1px solid #d8d8d8}.adf-version-list-item-version{font-weight:700}.adf-version-list-item-date{opacity:.6}.adf-version-list-item-comment{opacity:.5}"]}]}],Xt.ctorParameters=function(){return[{type:C.AlfrescoApiService},{type:C.ContentService},{type:c.MatDialog}]},Xt.propDecorators={node:[{type:n.Input}],showComments:[{type:n.Input}],allowDownload:[{type:n.Input}],allowViewVersions:[{type:n.Input}],showActions:[{type:n.Input}],restored:[{type:n.Output}],deleted:[{type:n.Output}],viewVersion:[{type:n.Output}]};
/*!
     * @license
     * Copyright 2019 Alfresco Software, Ltd.
     *
...
/*!
     ...
     * limitations under the License.
     */
var en=function(){};en.decorators=[{type:n.NgModule,args:[{imports:[t.CommonModule,j,C.CoreModule,ct,N.FormsModule],exports:[Zt,Kt,Xt,N.FormsModule,Jt],declarations:[Zt,Kt,Xt,Jt]}]}];
/*!
     * @license
     * Copyright 2019 Alfresco Software, Ltd.
     *
...
/*!
     ...
     * limitations under the License.
     */
var tn=function(){function e(){this.name="",this.path=""}return e.prototype.ngOnInit=function(){if(this.row){this.name=this.row.getValue("name");var e=this.row.getValue("path");e&&(this.path=e.name||"")}},e}();tn.decorators=[{type:n.Component,args:[{selector:"adf-name-location-cell",template:'\n        <div class="adf-name-location-cell-name adf-datatable-cell-value" [title]="name">{{ name }}</div>\n        <div class="adf-name-location-cell-location adf-datatable-cell-value" [title]="path">{{ path }}</div>\n    ',encapsulation:n.ViewEncapsulation.None,changeDetection:n.ChangeDetectionStrategy.OnPush,host:{class:"adf-name-location-cell adf-datatable-content-cell"}}]}],tn.propDecorators={row:[{type:n.Input}]};
/*!
     * @license
     * Copyright 2019 Alfresco Software, Ltd.
     *
...
/*!
     ...
     * limitations under the License.
     */
var rn=function(){};rn.decorators=[{type:n.NgModule,args:[{imports:[N.FormsModule,N.ReactiveFormsModule,C.CoreModule,t.CommonModule,j,qt,zt,jt,Gt,ct,re],exports:[on,tn,J],declarations:[on,tn,J],providers:[Ot]}]}];
/*!
     * @license
     * Copyright 2019 Alfresco Software, Ltd.
     *
...
/*!
     ...
     * limitations under the License.
     */
var an="CORE.FOLDER_DIALOG.FOLDER_NAME.ERRORS";function sn(e){var t=e.value;return!/([\*\"\<\>\\\/\?\:\|])/.test(t)?null:{message:an+".SPECIAL_CHARACTERS"}}function ln(e){return"."!==(e.value||"").trim().split("").pop()?null:{message:an+".ENDING_DOT"}}function cn(e){return!!(e.value||"").trim()?null:{message:an+".ONLY_SPACES"}}
/*!
     * @license
     * Copyright 2019 Alfresco Software, Ltd.
     *
...
/*!
     ...
     * limitations under the License.
     */
var un=function(){};un.decorators=[{type:n.NgModule,args:[{imports:[t.CommonModule,j,C.CoreModule,N.FormsModule,N.ReactiveFormsModule,P.MatMomentDatetimeModule,F.MatDatetimepickerModule],declarations:[dn,ee,Wt,pn],exports:[dn,ee,Wt,pn]}]}];
/*!
     * @license
     * Copyright 2019 Alfresco Software, Ltd.
     *
...
/*!
     ...
     * limitations under the License.
     */
var hn=function(){function e(e,t){this.dialogRef=e,this.content=t,this.parentNodeId="-my-",this.title=null,this.nodeType="cm:folder",this.error=new n.EventEmitter,this.success=new n.EventEmitter}return e.prototype.onClick=function(e){e.preventDefault(),this.openDialog()},Object.defineProperty(e.prototype,"dialogConfig",{get:function(){var t=e.DIALOG_WIDTH,n=this;return{data:{parentNodeId:n.parentNodeId,createTitle:n.title,nodeType:n.nodeType},width:t+"px"}},enumerable:!1,configurable:!0}),e.prototype.openDialog=function(){var e=this,t=this,n=t.dialogRef,i=t.dialogConfig,o=t.content,r=n.open(dn,i);r.componentInstance.error.subscribe((function(t){e.error.emit(t)})),r.componentInstance.success.subscribe((function(t){e.success.emit(t)})),r.afterClosed().subscribe((function(e){e&&o.folderCreate.next(e)}))},e}();hn.DIALOG_WIDTH=400,hn.decorators=[{type:n.Directive,args:[{selector:"[adf-create-folder]"}]}],hn.ctorParameters=function(){return[{type:c.MatDialog},{type:C.ContentService}]},hn.propDecorators={parentNodeId:[{type:n.Input,args:["adf-create-folder"]}],title:[{type:n.Input}],nodeType:[{type:n.Input}],error:[{type:n.Output}],success:[{type:n.Output}],onClick:[{type:n.HostListener,args:["click",["$event"]]}]};
/*!
     * @license
     * Copyright 2019 Alfresco Software, Ltd.
     *
     ...
     * limitations under the License.
     */
var fn=function(){function e(e,t,i){this.dialogRef=e,this.elementRef=t,this.content=i,this.error=new n.EventEmitter,this.title=null,this.success=new n.EventEmitter}return e.prototype.onClick=function(e){e.preventDefault(),this.folder&&this.openDialog()},Object.defineProperty(e.prototype,"dialogConfig",{get:function(){var t=e.DIALOG_WIDTH;return{data:{folder:this.folder,editTitle:this.title},width:t+"px"}},enumerable:!1,configurable:!0}),e.prototype.openDialog=function(){var e=this,t=this,n=t.dialogRef,i=t.dialogConfig,o=t.content,r=n.open(dn,i);r.componentInstance.error.subscribe((function(t){e.error.emit(t)})),r.componentInstance.success.subscribe((function(t){e.success.emit(t)})),r.afterClosed().subscribe((function(e){e&&o.folderEdit.next(e)}))},e}();fn.DIALOG_WIDTH=400,fn.decorators=[{type:n.Directive,args:[{selector:"[adf-edit-folder]"}]}],fn.ctorParameters=function(){return[{type:c.MatDialog},{type:n.ElementRef},{type:C.ContentService}]},fn.propDecorators={folder:[{type:n.Input,args:["adf-edit-folder"]}],error:[{type:n.Output}],title:[{type:n.Input}],success:[{type:n.Output}],onClick:[{type:n.HostListener,args:["click",["$event"]]}]};
/*!
     * @license
     * Copyright 2019 Alfresco Software, Ltd.
     *
     ...
     * limitations under the License.
     */
var mn=function(){};mn.decorators=[{type:n.NgModule,args:[{imports:[t.CommonModule,j],declarations:[hn,fn],exports:[hn,fn]}]}];
/*!
     * @license
     * Copyright 2019 Alfresco Software, Ltd.
     *
...
/*!
     ...
     * limitations under the License.
     */
var Dn={properties:{}};function wn(e,t){return e[t]}function Nn(e,t,n){var i,o,r=wn(e,t)||Dn;return"*"===n?(o=r.properties,i=Object.keys(o).map((function(e){return o[e]}))):i=r.properties[n],i}
/*!
     * @license
     * Copyright 2019 Alfresco Software, Ltd.
     *
...
/*!
     ...
     * See the License for the specific language governing permissions and
     * limitations under the License.
     */Pn.INDIFFERENT_PRESET="*",Pn.DEFAULT_PRESET_NAME="default",Pn.ɵprov=n.ɵɵdefineInjectable({factory:function(){return new Pn(n.ɵɵinject(C.AppConfigService),n.ɵɵinject(C.LogService))},token:Pn,providedIn:"root"}),Pn.decorators=[{type:n.Injectable,args:[{providedIn:"root"}]}],Pn.ctorParameters=function(){return[{type:C.AppConfigService},{type:C.LogService}]};var Mn=function(){function e(e){this.alfrescoApiService=e}return e.prototype.load=function(e){var t=this,n=e.map((function(e){return e.replace(":","_")})).map((function(e){return T.defer((function(){return t.alfrescoApiService.classesApi.getClass(e)}))}));return T.forkJoin(n).pipe(O.map(this.convertToObject))},e.prototype.convertToObject=function(e){return e.reduce((function(e,t){var n;return Object.assign({},e,((n={})[t.name]=t,n))}),{})},e}();Mn.ɵprov=n.ɵɵdefineInjectable({factory:function(){return new Mn(n.ɵɵinject(C.AlfrescoApiService))},token:Mn,providedIn:"root"}),Mn.decorators=[{type:n.Injectable,args:[{providedIn:"root"}]}],Mn.ctorParameters=function(){return[{type:C.AlfrescoApiService}]};var kn=function(){function e(e){this.alfrescoApiService=e}return e.prototype.getContentTypeByPrefix=function(e){return T.from(this.alfrescoApiService.typesApi.getType(e))},e.prototype.getContentTypeChildren=function(e){var t={where:"(parentId in ('"+e+"') and not namespaceUri matches('http://www.alfresco.*'))",include:["properties"]};return T.from(this.alfrescoApiService.typesApi.listTypes(t)).pipe(O.map((function(e){return e.list.entries})))},e}();kn.ɵprov=n.ɵɵdefineInjectable({factory:function(){return new kn(n.ɵɵinject(C.AlfrescoApiService))},token:kn,providedIn:"root"}),kn.decorators=[{type:n.Injectable,args:[{providedIn:"root"}]}],kn.ctorParameters=function(){return[{type:C.AlfrescoApiService}]};
/*!
     * @license
     * Copyright 2019 Alfresco Software, Ltd.
     *
...
/*!
     ...
     * limitations under the License.
     */
var Hn=function(){};Hn.decorators=[{type:n.NgModule,args:[{imports:[t.CommonModule,j,L.FlexLayoutModule,C.CoreModule],exports:[Vn,Gn],declarations:[Vn,Gn]}]}];
/*!
     * @license
     * Copyright 2019 Alfresco Software, Ltd.
     *
...
/*!
     ...
     * limitations under the License.
     */
var qn=function(e){this.isInherited=!1,e&&(this.authorityId=e.authorityId,this.name=e.name,this.accessStatus=e.accessStatus,this.isInherited=null!==e.isInherited&&void 0!==e.isInherited&&e.isInherited,this.icon=e.icon?e.icon:"vpn_key")},Yn=function(){function e(e,t,n,i){this.apiService=e,this.searchApiService=t,this.nodeService=n,this.translation=i}return e.prototype.getNodeRoles=function(e){var t=this,n=this.buildRetrieveSiteQueryBody(e.path.elements);return this.searchApiService.searchByQueryBody(n).pipe(O.switchMap((function(n){var i;if(n.list.entries.length>0){var o=n.list.entries[0].entry.name;return t.getGroupMembersBySiteName(o)}return T.of(null===(i=e.permissions)||void 0===i?void 0:i.settable)})))},e.prototype.getNodePermissions=function(e){var t,n,i=[];return(null===(t=null==e?void 0:e.permissions)||void 0===t?void 0:t.locallySet)&&e.permissions.locallySet.map((function(e){i.push(new qn(e))})),(null===(n=null==e?void 0:e.permissions)||void 0===n?void 0:n.inherited)&&e.permissions.inherited.map((function(e){var t=new qn(e);t.isInherited=!0,i.push(t)})),i},e.prototype.updatePermissionRole=function(e,t){var n={permissions:{locallySet:[]}},i=e.permissions.locallySet.map((function(e){return e.authorityId})).indexOf(t.authorityId);return n.permissions.locallySet=n.permissions.locallySet.concat(e.permissions.locallySet),-1!==i?n.permissions.locallySet[i]=t:n.permissions.locallySet.push(t),this.nodeService.updateNode(e.id,n)},e.prototype.updateNodePermissions=function(e,t){var n=this;return this.nodeService.getNode(e).pipe(O.switchMap((function(e){return n.updateLocallySetPermissions(e,t)})))},e.prototype.updateLocallySetPermissions=function(e,t){var n={permissions:{locallySet:[]}},i=t,o=this.getDuplicatedPermissions(e.permissions.locallySet,i);if(o.length>0){var r=o.map((function(e){return"authority -> "+e.authorityId+" / role -> "+e.name})).join(", "),a=this.translation.instant("PERMISSION_MANAGER.ERROR.DUPLICATE-PERMISSION",{list:r});return T.throwError(a)}return n.permissions.locallySet=e.permissions.locallySet?e.permissions.locallySet.concat(i):i,this.nodeService.updateNode(e.id,n)},e.prototype.getDuplicatedPermissions=function(e,t){var n=this,i=[];return e&&t.forEach((function(t){var o=e.find((function(e){return n.isEqualPermission(e,t)}));o&&i.push(o)})),i},e.prototype.isEqualPermission=function(e,t){return e.accessStatus===t.accessStatus&&e.authorityId===t.authorityId&&e.name===t.name},e.prototype.removePermission=function(e,t){var n={permissions:{locallySet:[]}},i=e.permissions.locallySet.map((function(e){return e.authorityId})).indexOf(t.authorityId);return-1!==i?(e.permissions.locallySet.splice(i,1),n.permissions.locallySet=e.permissions.locallySet,this.nodeService.updateNode(e.id,n)):T.of(e)},e.prototype.getGroupMembersBySiteName=function(e){var t=this,n="GROUP_site_"+e;return this.getGroupMemberByGroupName(n).pipe(O.map((function(n){var i=[];return n.list.entries.forEach((function(n){i.push(t.formattedRoleName(n.entry.displayName,"site_"+e))})),i})))},e.prototype.getGroupMemberByGroupName=function(e,t){return T.from(this.apiService.groupsApi.listGroupMemberships(e,t))},e.prototype.formattedRoleName=function(e,t){return e.replace(t+"_","")},e.prototype.buildRetrieveSiteQueryBody=function(e){return{query:{query:e.map((function(e){return'name: "'+e.name+'"'})).join(" OR ")},paging:{maxItems:100,skipCount:0},include:["aspectNames","properties"],filterQueries:[{query:"TYPE:'st:site'"}]}},e.prototype.getLocalPermissions=function(e){var t,n=[];return(null===(t=null==e?void 0:e.permissions)||void 0===t?void 0:t.locallySet)&&e.permissions.locallySet.forEach((function(e){n.push(new qn(e))})),n},e.prototype.getInheritedPermission=function(e){var t,n=[];return(null===(t=null==e?void 0:e.permissions)||void 0===t?void 0:t.inherited)&&e.permissions.inherited.forEach((function(e){var t=new qn(e);t.isInherited=!0,n.push(t)})),n},e.prototype.removePermissions=function(e,t){var n={permissions:{locallySet:[]}};return t.forEach((function(t){var n=e.permissions.locallySet.findIndex((function(e){return e.authorityId===t.authorityId}));-1!==n&&e.permissions.locallySet.splice(n,1)})),n.permissions.locallySet=e.permissions.locallySet,this.nodeService.updateNode(e.id,n)},e.prototype.updatePermissions=function(e,t){var n={permissions:{locallySet:[]}};return n.permissions.locallySet=t,this.nodeService.updateNode(e.id,n)},e.prototype.getNodeWithRoles=function(e){var t=this;return this.nodeService.getNode(e).pipe(O.switchMap((function(e){return T.forkJoin({node:T.of(e),roles:t.getNodeRoles(e).pipe(O.catchError((function(){var t;return T.of(null===(t=e.permissions)||void 0===t?void 0:t.settable)})),O.map((function(e){return e.map((function(e){return{role:e,label:e}}))})))})})))},e.prototype.transformNodeToUserPerson=function(e){var t=null,n=null;if("cm:person"===e.nodeType){var i=e.properties["cm:firstName"],o=e.properties["cm:lastName"],r=e.properties["cm:email"],a=e.properties["cm:userName"];t=new C.EcmUserModel({id:a,firstName:i,lastName:o,email:r})}if("cm:authorityContainer"===e.nodeType){var s=e.properties["cm:authorityDisplayName"]||e.properties["cm:authorityName"];a=e.properties["cm:authorityName"];n=new D.Group({displayName:s,id:a})}return{person:t,group:n}},e}();Yn.ɵprov=n.ɵɵdefineInjectable({factory:function(){return new Yn(n.ɵɵinject(C.AlfrescoApiService),n.ɵɵinject(C.SearchService),n.ɵɵinject(C.NodesApiService),n.ɵɵinject(C.TranslationService))},token:Yn,providedIn:"root"}),Yn.decorators=[{type:n.Injectable,args:[{providedIn:"root"}]}],Yn.ctorParameters=function(){return[{type:C.AlfrescoApiService},{type:C.SearchService},{type:C.NodesApiService},{type:C.TranslationService}]};
/*!
     * @license
     * Copyright 2019 Alfresco Software, Ltd.
     *
...
/*!
     ...
     * limitations under the License.
     */
var Jn=new n.InjectionToken("Alfresco Search Query Token"),ei=function(){function e(e){this.queryProvider=e}return e.prototype.generateQueryBody=function(e,t,n){return{query:{query:this.getQuery(e)},include:["properties","aspectNames"],paging:{maxItems:t,skipCount:n},filterQueries:[{query:"TYPE:'cm:authority'"}]}},e.prototype.getQuery=function(e){return this.queryProvider&&this.queryProvider.query?this.queryProvider.query.replace(new RegExp(/\${([^}]+)}/g),e):"(email:*"+e+"* OR firstName:*"+e+"* OR lastName:*"+e+"* OR displayName:*"+e+"* OR authorityName:*"+e+"* OR authorityDisplayName:*"+e+'*) AND ANAME:("0/APP.DEFAULT")'},e}();ei.decorators=[{type:n.Injectable}],ei.ctorParameters=function(){return[{type:void 0,decorators:[{type:n.Optional},{type:n.Inject,args:[Jn]}]}]};var ti=function(){function e(){var e=this;this.select=new n.EventEmitter,this.searchInput=new N.FormControl,this.searchedWord="",this.debounceSearch=200,this.selectedItems=[],this.EVERYONE=new D.NodeEntry({entry:{nodeType:"cm:authorityContainer",properties:{"cm:authorityName":"GROUP_EVERYONE"}}}),this.searchInput.valueChanges.pipe(O.debounceTime(this.debounceSearch)).subscribe((function(t){var n,i=e.matSelectionList.selectedOptions.selected.map((function(e){return e.value}));(n=e.selectedItems).push.apply(n,z(i)),e.matSelectionList.deselectAll(),e.searchedWord=t,t||e.search.resetResults()}))}return e.prototype.onSelectionChange=function(){var e=z(this.matSelectionList.selectedOptions.selected.map((function(e){return e.value})),this.selectedItems).reduce((function(e,t){return e.find((function(e){return e.entry.id===t.entry.id}))||e.push(t),e}),[]);this.select.emit(e)},e.prototype.clearSearch=function(){this.searchedWord="",this.selectedItems.splice(0,this.selectedItems.length),this.search.resetResults()},e}();ti.decorators=[{type:n.Component,args:[{selector:"adf-add-permission-panel",template:'<mat-form-field floatPlaceholder="never"\n                class="adf-permission-search-input">\n    <input matInput\n           id="searchInput"\n           [formControl]="searchInput"\n           type="text"\n           placeholder="{{\'PERMISSION_MANAGER.ADD-PERMISSION.SEARCH\' | translate}}"\n           [value]="searchedWord">\n\n    <mat-icon *ngIf="searchedWord?.length > 0"\n              class="adf-permission-search-icon"\n              data-automation-id="adf-permission-clear-input"\n              id="adf-permission-clear-input"\n              matSuffix\n              (click)="clearSearch()">clear\n    </mat-icon>\n\n    <mat-icon *ngIf="searchedWord?.length === 0"\n              class="adf-permission-search-icon"\n              data-automation-id="adf-permission-search-icon"\n              matSuffix>search\n    </mat-icon>\n</mat-form-field>\n\n<div *ngIf="searchedWord?.length === 0"\n     class="adf-permission-start-message"\n     id="adf-add-permission-type-search">\n    <span>{{\'PERMISSION_MANAGER.ADD-PERMISSION.TYPE-MESSAGE\' | translate}}</span>\n</div>\n\n<adf-search #search\n            [searchTerm]="searchedWord"\n            id="adf-add-permission-authority-results"\n            class="adf-permission-result-list"\n            [class.adf-permission-result-list-search]="searchedWord.length === 0">\n    <ng-template let-data>\n        <mat-selection-list class="adf-permission-result-list-elements" (keydown.control.a)="onSelectionChange()"\n                            (selectionChange)="onSelectionChange()">\n            <mat-list-option id="adf-add-permission-group-everyone"\n                             class="adf-list-option-item"\n                             #eveyone\n                             disableRipple\n                             [value]="EVERYONE">\n                <adf-user-icon-column [node]="EVERYONE" id="add-group-icon" [selected]="eveyone.selected"></adf-user-icon-column>\n                <p class="adf-result-name">\n                    {{\'PERMISSION_MANAGER.ADD-PERMISSION.EVERYONE\' | translate}}\n                </p>\n            </mat-list-option>\n\n            <mat-list-option *ngFor="let item of data?.list?.entries; let idx = index"\n                             disableRipple\n                             [value]="item"\n                             class="adf-list-option-item"\n                             id="result_option_{{idx}}"\n                             #option>\n                <adf-user-icon-column [node]="item" [selected]="option.selected"></adf-user-icon-column>\n                <p class="adf-result-name">\n                    <ng-container *ngIf="item.entry?.properties[\'cm:authorityDisplayName\']; else authorityName">\n                        {{item.entry.properties[\'cm:authorityDisplayName\']}}\n                    </ng-container>\n                    <ng-template #authorityName>\n                        <ng-container *ngIf="item.entry?.properties[\'cm:authorityName\']; else owner">\n                            {{item.entry.properties[\'cm:authorityName\']}}\n                        </ng-container>\n                    </ng-template>\n                    <ng-template #owner>\n                        {{item.entry?.properties[\'cm:firstName\'] ? item.entry?.properties[\'cm:firstName\'] : \'\' }}\n                        {{item.entry?.properties[\'cm:lastName\'] ? item.entry?.properties[\'cm:lastName\']: \'\'}}\n                    </ng-template>\n                </p>\n            </mat-list-option>\n        </mat-selection-list>\n    </ng-template>\n</adf-search>\n',encapsulation:n.ViewEncapsulation.None,providers:[{provide:C.SearchConfigurationService,useClass:ei},C.SearchService]}]}],ti.ctorParameters=function(){return[]},ti.propDecorators={search:[{type:n.ViewChild,args:["search",{static:!0}]}],matSelectionList:[{type:n.ViewChild,args:[h.MatSelectionList,{static:!1}]}],select:[{type:n.Output}]};
/*!
     * @license
     * Copyright 2019 Alfresco Software, Ltd.
     *
...
/*!
     ...
     * limitations under the License.
     */
var oi=function(){function e(e){this.nodePermissionService=e,this.displayText$=new T.BehaviorSubject(""),this.subTitleText$=new T.BehaviorSubject("")}return e.prototype.ngOnInit=function(){var e,t;if(null!=this.context){var n=null!==(t=null===(e=this.context.row.obj)||void 0===e?void 0:e.entry)&&void 0!==t?t:this.context.row.obj,i=n.person,o=n.group,r=n.authorityId,a=r?{displayName:r}:null;this.updatePerson(i),this.updateGroup(o||a)}if(this.node){var s=this.nodePermissionService.transformNodeToUserPerson(this.node.entry);i=s.person,o=s.group;this.updatePerson(i),this.updateGroup(o)}},e.prototype.updatePerson=function(e){var t,n,i;e&&(this.displayText$.next((null!==(t=e.firstName)&&void 0!==t?t:"")+" "+(null!==(n=e.lastName)&&void 0!==n?n:"")),this.subTitleText$.next(null!==(i=e.email)&&void 0!==i?i:""))},e.prototype.updateGroup=function(e){e&&this.displayText$.next(e.displayName)},e}();oi.decorators=[{type:n.Component,args:[{selector:"adf-user-name-column",template:'\n        <div class="adf-ellipsis-cell" [attr.data-automation-id]="displayText$ | async">\n            <span class="adf-user-name-column" title="{{ displayText$ | async }}"> {{ displayText$ | async }}</span>\n            <br/>\n            <span class="adf-user-email-column" title="{{ subTitleText$ | async }}" *ngIf="subTitleText$ | async">\n                {{ subTitleText$ | async }}\n            </span>\n        </div>\n    ',host:{class:"adf-user-name-column adf-datatable-content-cell adf-expand-cell-5 adf-ellipsis-cell"}}]}],oi.ctorParameters=function(){return[{type:Yn}]},oi.propDecorators={context:[{type:n.Input}],node:[{type:n.Input}]};
/*!
     * @license
     * Copyright 2019 Alfresco Software, Ltd.
     *
     ...
     * limitations under the License.
     */
var ri=function(){function e(){this.readonly=!1,this.placeholder="PERMISSION_MANAGER.LABELS.SELECT-ROLE",this.roleChanged=new n.EventEmitter}return e.prototype.onRoleChanged=function(e){this.value=e,this.roleChanged.emit(e)},e}();ri.decorators=[{type:n.Component,args:[{selector:"adf-user-role-column",template:'\n      <mat-form-field floatLabel="never" class="adf-role-selector-field" *ngIf="!readonly">\n          <mat-select\n              (click)="$event.stopPropagation()"\n              [placeholder]="placeholder | translate"\n              [value]="value"\n              (selectionChange)="onRoleChanged($event.value)">\n              <mat-option *ngFor="let role of roles" [value]="role.role">\n                  {{ role.label | adfLocalizedRole }}\n              </mat-option>\n          </mat-select>\n      </mat-form-field>\n\n      <span class="adf-datatable-cell-value adf-readonly-role" [title]="value | adfLocalizedRole" *ngIf="readonly">\n          {{value | adfLocalizedRole}}\n      </span>\n  ',host:{class:"adf-user-role-column adf-datatable-content-cell adf-expand-cell-4"},styles:[".adf-role-selector-field {\n            width: 100%;\n            .mat-form-field {\n                width: 100%;\n                max-width: 200px;\n            }\n        }\n        .adf-readonly-role {\n            padding-left: 0 !important;\n        }\n        "]}]}],ri.propDecorators={roles:[{type:n.Input}],value:[{type:n.Input}],readonly:[{type:n.Input}],placeholder:[{type:n.Input}],roleChanged:[{type:n.Output}]};var ai=function(){function e(){this.displayText$=new T.BehaviorSubject("")}return e.prototype.ngOnInit=function(){this.updateValue()},e.prototype.updateValue=function(){this.displayText$.next(this.node.path.name)},e}();ai.decorators=[{type:n.Component,args:[{selector:"adf-node-path-column",template:'\n        <span class="adf-user-name-column adf-datatable-cell-value"  title="{{ displayText$ | async }}">\n            {{ displayText$ | async }}\n        </span>\n    ',host:{class:"adf-node-path-column adf-datatable-content-cell"}}]}],ai.propDecorators={node:[{type:n.Input}]};
/*!
     * @license
     * Copyright 2019 Alfresco Software, Ltd.
     *
...
/*!
     ...
     * limitations under the License.
     */
var li=function(){function e(e,t,n){this.element=e,this.overlay=t,this.vcr=n,this.panelClass="adf-permission-pop-over",this._open=!1,this.destroy$=new T.Subject}return Object.defineProperty(e.prototype,"open",{get:function(){return this._open},enumerable:!1,configurable:!0}),e.prototype.ngOnInit=function(){this.createOverlay()},e.prototype.ngAfterViewInit=function(){var e=this;this.element.nativeElement.addEventListener("click",(function(){return e.attachOverlay()}))},e.prototype.ngOnDestroy=function(){this.detachOverlay(),this.destroy$.next(),this.destroy$.complete()},e.prototype.createOverlay=function(){var e=this,t=this.overlay.scrollStrategies.reposition(),n=this.overlay.position().flexibleConnectedTo(this.target).withPositions([new x.ConnectionPositionPair({originX:"start",originY:"bottom"},{overlayX:"start",overlayY:"top"}),new x.ConnectionPositionPair({originX:"start",originY:"top"},{overlayX:"start",overlayY:"bottom"})]).withPush(!1);this.overlayRef=this.overlay.create({positionStrategy:n,scrollStrategy:t,hasBackdrop:!0,backdropClass:"cdk-overlay-transparent-backdrop",panelClass:this.panelClass}),this.overlayRef.backdropClick().pipe(O.takeUntil(this.destroy$)).subscribe((function(){e._open=!1,e.detachOverlay()}))},e.prototype.attachOverlay=function(){if(!this.overlayRef.hasAttached()){var e=new _.TemplatePortal(this.popOver,this.vcr);this.overlayRef.attach(e),this._open=!0}},e.prototype.detachOverlay=function(){this.overlayRef.hasAttached()&&this.overlayRef.detach()},e}();li.decorators=[{type:n.Directive,args:[{selector:"[adf-pop-over]",exportAs:"adfPopOver"}]}],li.ctorParameters=function(){return[{type:n.ElementRef},{type:x.Overlay},{type:n.ViewContainerRef}]},li.propDecorators={popOver:[{type:n.Input,args:["adf-pop-over"]}],target:[{type:n.Input}],panelClass:[{type:n.Input}]};
/*!
     * @license
     * Copyright 2019 Alfresco Software, Ltd.
     *
...
/*!
     ...
     * limitations under the License.
     */
var ci=function(){};ci.decorators=[{type:n.NgModule,args:[{imports:[C.CoreModule,t.CommonModule,N.FormsModule,N.ReactiveFormsModule,j,jt,C.PipeModule],declarations:[Kn,ti,Zn,ni,zn,oi,ii,ri,li,ai,si],exports:[Kn,ti,Zn,ni,zn,oi,ii,ri,li,ai]}]}];
/*!
     * @license
     * Copyright 2019 Alfresco Software, Ltd.
     *
...
/*!
     ...
     * limitations under the License.
     */
var pi=function(){function e(e,t,n){this.dialog=e,this.zone=t,this.alfrescoApiService=n,this.isFile=!1,this.isShared=!1,this.onDestroy$=new T.Subject}return e.prototype.ngOnDestroy=function(){this.onDestroy$.next(!0),this.onDestroy$.complete()},e.prototype.shareNode=function(e){var t=this;if(e&&e.entry&&e.entry.isFile){var n=e.entry.nodeId||e.entry.guid;n?this.getNodeInfo(n).subscribe((function(e){t.openShareLinkDialog({entry:e})})):this.openShareLinkDialog(e)}},e.prototype.getNodeInfo=function(e){return T.from(this.alfrescoApiService.nodesApi.getNodeInfo(e,{include:["allowableOperations"]}))},e.prototype.openShareLinkDialog=function(e){this.dialog.open(di,{width:"600px",panelClass:"adf-share-link-dialog",data:{node:e,baseShareUrl:this.baseShareUrl}})},e.prototype.ngOnChanges=function(){var e=this;this.zone.onStable.pipe(O.takeUntil(this.onDestroy$)).subscribe((function(){e.node&&e.node.entry&&(e.isFile=e.node.entry.isFile,e.isShared=!!e.node.entry.properties&&e.node.entry.properties["qshare:sharedId"])}))},e.prototype.onClick=function(){this.node&&this.shareNode(this.node)},e}();pi.decorators=[{type:n.Directive,args:[{selector:"[adf-share]",exportAs:"adfShare"}]}],pi.ctorParameters=function(){return[{type:c.MatDialog},{type:n.NgZone},{type:C.AlfrescoApiService}]},pi.propDecorators={node:[{type:n.Input,args:["adf-share"]}],baseShareUrl:[{type:n.Input}],onClick:[{type:n.HostListener,args:["click"]}]};
/*!
     * @license
     * Copyright 2019 Alfresco Software, Ltd.
     *
     ...
     * limitations under the License.
     */
var ui=function(){function e(){}return e.forRoot=function(){return{ngModule:e}},e.forChild=function(){return{ngModule:e}},e}();ui.decorators=[{type:n.NgModule,args:[{imports:[C.CoreModule,t.CommonModule,j],declarations:[di,pi],exports:[di,pi]}]}];
/*!
     * @license
     * Copyright 2019 Alfresco Software, Ltd.
     *
...
/*!
     ...
     * limitations under the License.
     */
var yi=function(){};yi.decorators=[{type:n.NgModule,args:[{imports:[t.CommonModule,j,A.TranslateModule],declarations:[gi],exports:[gi]}]}];
/*!
     * @license
     * Copyright 2019 Alfresco Software, Ltd.
     *
...
/*!
     ...
     * limitations under the License.
     */
var vi=function(){function e(e){this.alfrescoApiService=e}return e.prototype.listAllGroupMembershipsForPerson=function(e,t,n){return void 0===n&&(n=[]),H(this,void 0,void 0,(function(){var i,o;return q(this,(function(r){switch(r.label){case 0:return[4,this.alfrescoApiService.groupsApi.listGroupMembershipsForPerson(e,t)];case 1:return i=r.sent(),n=z(n,i.list.entries),i.list.pagination.hasMoreItems?(o=i.list.pagination.skipCount+i.list.pagination.count,[2,this.listAllGroupMembershipsForPerson(e,{maxItems:t.maxItems,skipCount:o},n)]):[2,n]}}))}))},e}();vi.ɵprov=n.ɵɵdefineInjectable({factory:function(){return new vi(n.ɵɵinject(C.AlfrescoApiService))},token:vi,providedIn:"root"}),vi.decorators=[{type:n.Injectable,args:[{providedIn:"root"}]}],vi.ctorParameters=function(){return[{type:C.AlfrescoApiService}]};
/*!
     * @license
     * Copyright 2019 Alfresco Software, Ltd.
     *
...
/*!
     ...
     * limitations under the License.
     */
var Si=function(){};Si.decorators=[{type:n.NgModule,args:[{imports:[t.CommonModule,V.MatTableModule,d.MatExpansionModule,r.MatCheckboxModule,C.PipeModule,A.TranslateModule,c.MatDialogModule,i.MatButtonModule,B.MatTooltipModule,g.MatProgressSpinnerModule],exports:[bi,Bn],declarations:[bi,Bn]}]}];
/*!
     * @license
     * Copyright 2019 Alfresco Software, Ltd.
     *
...
/*!
     ...
     * limitations under the License.
     */
var Ii=function(){};Ii.decorators=[{type:n.NgModule,args:[{imports:[t.CommonModule,V.MatTableModule,d.MatExpansionModule,r.MatCheckboxModule,A.TranslateModule,c.MatDialogModule,i.MatButtonModule],exports:[xn],declarations:[xn]}]}];
/*!
     * @license
     * Copyright 2019 Alfresco Software, Ltd.
     *
...
/*!
     ...
     * limitations under the License.
     */
var Ei=function(){function e(){}return e.forRoot=function(){return{ngModule:e,providers:[{provide:C.TRANSLATION_PROVIDER,multi:!0,useValue:{name:"adf-content-services",source:"assets/adf-content-services"}}]}},e.forChild=function(){return{ngModule:e}},e}();Ei.decorators=[{type:n.NgModule,args:[{imports:[C.CoreModule,ce,fe,t.CommonModule,ge,N.FormsModule,N.ReactiveFormsModule,un,jt,Gt,ct,j,qt,zt,rn,ui,Hn,mn,re,ci,en,yi,Ii,Si],providers:[{provide:C.TRANSLATION_PROVIDER,multi:!0,useValue:{name:"adf-content-services",source:"assets/adf-content-services"}}],exports:[ce,fe,ge,Gt,ct,jt,qt,zt,rn,ui,Hn,un,mn,re,ci,en,yi,Si,Ii]}]}],
/*!
     * @license
     * Copyright 2019 Alfresco Software, Ltd.
     *
     ...
     * limitations under the License.
     */
e.AddPermissionComponent=ni,e.AddPermissionDialogComponent=zn,e.AddPermissionPanelComponent=ti,e.AspectListComponent=bi,e.AspectListDialogComponent=Bn,e.AspectListModule=Si,e.AspectListService=jn,e.AspectOrientedConfigService=Ln,e.BasicPropertiesService=gn,e.BreadcrumbComponent=Yt,e.BreadcrumbModule=zt,e.ConfirmDialogComponent=Wt,e.ContentActionComponent=Fe,e.ContentActionListComponent=Re,e.ContentActionModel=Ie,e.ContentDirectiveModule=re,e.ContentInfo=ze,e.ContentMetadataCardComponent=Gn,e.ContentMetadataComponent=Vn,e.ContentMetadataConfigFactory=Pn,e.ContentMetadataModule=Hn,e.ContentMetadataService=Un,e.ContentModule=Ei,e.ContentNodeDialogService=te,e.ContentNodeSelectorComponent=J,e.ContentNodeSelectorModule=rn,e.ContentNodeSelectorPanelComponent=on,e.ContentNodeSelectorPanelService=Lt,e.ContentNodeShareModule=ui,e.ContentTypeDialogComponent=xn,e.ContentTypeModule=Ii,e.ContentTypePropertiesService=_n,e.ContentTypeService=kn,e.CustomResourcesService=X,e.DialogModule=un,e.DocumentActionModel=Ee,e.DocumentActionsService=Ne,e.DocumentListComponent=Oe,e.DocumentListModule=Gt,e.DocumentListService=Z,e.DropdownBreadcrumbComponent=Qt,e.DropdownSitesComponent=Ht,e.EmptySearchResultComponent=dt,e.FileDraggableDirective=st,e.FileUploadErrorPipe=at,e.FileUploadingDialogComponent=Ze,e.FileUploadingListComponent=et,e.FileUploadingListRowComponent=Je,e.FilterHeaderComponent=Be,e.FolderActionModel=Ae,e.FolderActionsService=Le,e.FolderCreateDirective=hn,e.FolderDialogComponent=dn,e.FolderDirectiveModule=mn,e.FolderEditDirective=fn,e.GroupService=vi,e.IndifferentConfigService=Rn,e.InheritPermissionDirective=Zn,e.LayoutOrientedConfigService=Fn,e.LibraryDialogComponent=pn,e.LibraryNameColumnComponent=Pe,e.LibraryRoleColumnComponent=Me,e.LibraryStatusColumnComponent=ke,e.LikeComponent=le,e.MemberModel=Qn,e.NameColumnComponent=xe,e.NameLocationCellComponent=tn,e.NodeActionsService=we,e.NodeAspectService=$n,e.NodeCounterComponent=oe,e.NodeCounterDirective=ie,e.NodeEntityEvent=Ce,e.NodeEntryEvent=Te,e.NodeLockDialogComponent=ee,e.NodeLockDirective=ne,e.NodeMinimal=Ye,e.NodeMinimalEntry=He,e.NodePaging=$e,e.NodePagingList=Ge,e.NodePathColumnComponent=ai,e.NodePermissionDialogService=Wn,e.NodePermissionService=Yn,e.NodeSharedDirective=pi,e.Pagination=qe,e.PathElementEntity=Xe,e.PathInfoEntity=We,e.PermissionContainerComponent=si,e.PermissionDisplayModel=qn,e.PermissionListComponent=Kn,e.PermissionManagerModule=ci,e.PermissionModel=De,e.PermissionStyleModel=Ke,e.PopOverDirective=li,e.PropertyDescriptorsService=Mn,e.PropertyGroupTranslatorService=On,e.RatingComponent=se,e.RatingService=ae,e.ResetSearchDirective=Bt,e.SEARCH_QUERY_SERVICE_TOKEN=_e,e.SEARCH_QUERY_TOKEN=Jn,e.SearchCheckListComponent=bt,e.SearchChipListComponent=Nt,e.SearchComponent=ut,e.SearchControlComponent=pt,e.SearchDateRangeComponent=It,e.SearchDatetimeRangeComponent=At,e.SearchFacetFieldComponent=_t,e.SearchFacetFiltersService=Dt,e.SearchFilterChipsComponent=kt,e.SearchFilterComponent=wt,e.SearchFilterContainerComponent=Pt,e.SearchFilterMenuCardComponent=xt,e.SearchFilterService=Ct,e.SearchFormComponent=Mt,e.SearchHeaderQueryBuilderService=Ve,e.SearchModule=jt,e.SearchNumberRangeComponent=vt,e.SearchPanelComponent=Rt,e.SearchPermissionConfigurationService=ei,e.SearchQueryBuilderService=Ot,e.SearchRadioComponent=mt,e.SearchSliderComponent=gt,e.SearchSortingPickerComponent=Ft,e.SearchTextComponent=ht,e.SearchWidgetContainerComponent=Tt,e.ShareDataRow=ye,e.ShareDataTableAdapter=be,e.ShareDialogComponent=di,e.SitesDropdownModule=qt,e.SocialModule=ce,e.TagActionsComponent=pe,e.TagListComponent=ue,e.TagModule=fe,e.TagNodeListComponent=he,e.TagService=de,e.ToggleIconDirective=lt,e.TrashcanNameColumnComponent=je,e.TreeBaseNode=hi,e.TreeViewComponent=gi,e.TreeViewDataSource=mi,e.TreeViewModule=yi,e.TreeViewService=fi,e.UploadBase=nt,e.UploadButtonComponent=it,e.UploadDragAreaComponent=rt,e.UploadFilesEvent=tt,e.UploadModule=ct,e.UploadVersionButtonComponent=ot,e.UserIconColumnComponent=ii,e.UserInfo=Qe,e.UserNameColumnComponent=oi,e.UserRoleColumnComponent=ri,e.VersionComparisonComponent=Jt,e.VersionListComponent=Xt,e.VersionManagerComponent=Kt,e.VersionManagerModule=en,e.VersionUploadComponent=Zt,e.WebScriptModule=ge,e.WebscriptComponent=me,e.defaultValidation=nn,e.forbidEndingDot=ln,e.forbidOnlySpaces=cn,e.forbidSpecialCharacters=sn,e.ɵ0=St,e.ɵa=j,e.ɵb=Ue,e.ɵc=Ut,e.ɵd=Vt,e.ɵe=Xn,Object.defineProperty(e,"__esModule",{value:!0})}));
