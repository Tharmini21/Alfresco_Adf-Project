...
import { PeopleApi, SitesApi, SearchApi, FavoritesApi, SharedlinksApi, TrashcanApi, NodesApi, SearchRequest, SiteMemberPaging, NodeBodyLock, RatingBody, TagBody, Pagination as Pagination$1, Site, RequestSortDefinitionInner, SiteEntry, Group, NodeEntry } from '@alfresco/js-api';
